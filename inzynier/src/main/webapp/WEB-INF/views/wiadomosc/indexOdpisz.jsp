...
<body>
    ...
    <div class="main">
        ...
        <div class="letter">
            <s:form action="/wyslijRE/${wiadomoscTmp.odbiorca}" method="post" modelAttribute="wiadomosc" enctype="multipart/form-data">
                <div class="innerLetter">
                <br/><br/><br/>
                    <h3>Odbiorca: <s:input required = "required" path = "odbiorca" value="${wiadomoscTmp.odbiorca}" disabled="true"/> </h3><br/>
