...
public class MebleAssembler {
    public MebleDTO toDto(Meble meble){
        return new MebleDTO(meble.getNazwa(), meble.getPlik(), meble.getKategoria(), meble.getGlod(), meble.getSen(), meble.getPragnienie(), meble.getHigiena(), meble.getDoswiadczenia());
    }
    ...
    public Meble toEntity(MebleDTO mebleDTO){
        return new Meble(mebleDTO.getNazwa(), mebleDTO.getPlik(), mebleDTO.getKategoria(), mebleDTO.getGlod(), mebleDTO.getSen(), mebleDTO.getPragnienie(), mebleDTO.getHigiena(), mebleDTO.getDoswiadczenia());
    }
